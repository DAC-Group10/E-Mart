...
export function Product(props) {
    ...
    useEffect(() => {
        fetch("http://localhost:5265/api/Product/" + catmasterid)
            .then(res => res.json())
            ...
            <div className='catcontainer'>
                ...
                {Product.map(pro => (
                    ...
                    <Card className="procard">
                        <Card.Body>
                        <Card.Img className="img" src={pro.productImage}></Card.Img><br/><br/>
                        <Card.Title className="title">{pro.productName}</Card.Title>
                        <Card.Text>{pro.productDescription}</Card.Text>
                        <Card.Text>
                            <b>MRP:{pro.mrpPrice}</b><br/>
                            CardHolders Price:{pro.cardholdersPrice}<br/>
                            Points To Be Redeem:{pro.points_To_Be_Redeem}
                        </Card.Text>
